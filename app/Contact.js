          ...
          <div className="w-full flex flex-col gap-1 lg:flex-row lg:gap-16">
            ...
            <div className="flex-1">
              <textarea
                name="message"
                rows={14}
                className="block w-full p-2 text-gray-900 shadow appearance-none border rounded py-2 px-3  leading-tight focus:outline-none focus:shadow-outline sm:text-sm sm:leading-6 dark:text-white dark:bg-gray-900 dark:placeholder:text-gray-200 "
                defaultValue={""}
              />
            </div>
          </div>
