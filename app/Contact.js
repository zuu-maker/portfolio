          ...
          <div className="w-full flex  flex-col gap-1 lg:flex-row lg:gap-16">
            ...
            <div className="flex-1">
              <input
                name="name"
                type="text"
                className="block w-full p-2 border-0 h-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:text-white dark:bg-gray-900 dark:placeholder:text-gray-200 "
              />
            </div>
          </div>
          ...
          <div className="w-full flex flex-col gap-1 lg:flex-row lg:gap-16">
            ...
            <div className="flex-1">
              <textarea
                name="message"
                rows={14}
                className="block w-full border-0 dark:bg-gray-900 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:text-white"
                defaultValue={""}
              />
            </div>
          </div>
